...
<div style="background: #fff; width: 40%; border-radius: 20px; margin-top:50px; margin-left:30%;">
    ...
    <form class="" method="POST" style="padding: 20px;">
        @csrf
        <div class="form-group mb-6"><input type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInputEmail2" placeholder="Department Code" name="department_code" readonly>
        </div>
